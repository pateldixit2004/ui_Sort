...
class Dome_Screen extends StatefulWidget {
  const Dome_Screen({super.key});

  @override
  State<Dome_Screen> createState() => _Dome_ScreenState();
}

class _Dome_ScreenState extends State<Dome_Screen> {
  Future<void> refece()
  async {
    await Text("Dixit");
  }
  ...
  Widget build(BuildContext context) {
    ...
    onRefresh: () async {
      await
      RefreshIndicator.adaptive(child: Text("d"), onRefresh: () async {
        await Text("amdb");
      },);
    },
        child: Stack(
